...
public class StationWidgetConfigureActivity extends BaseDragonActivity {
    ...
    private static final String PREFS_NAME = "com.antyzero.smoksmog.ui.widget.StationWidget";
    private static final String PREF_PREFIX_KEY = "appwidget_";
    int mAppWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID;
    EditText mAppWidgetText;
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick( View v ) {
            final Context context = StationWidgetConfigureActivity.this;
            ...
            StationWidget.updateAppWidget( context, appWidgetManager, mAppWidgetId );
    ...
    public void onCreate( Bundle icicle ) {
        ...
        mAppWidgetText.setText( loadTitlePref( StationWidgetConfigureActivity.this, mAppWidgetId ) );
    }
}
